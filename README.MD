...
|-------|--------|:------:|------------|
| **IaC** | **Terraform** | <img src="https://upload.wikimedia.org/wikipedia/commons/0/04/Terraform_Logo.svg" width="90" height="90"/ style="background-color:white; padding:4px; border-radius:4px> | Infrastructure provisioning across environments |
